...
public class Main {
    ...
    private static void reziseArrayIfFull() {
    ...
    public static boolean removeTodoList(Integer number) {
        if (isSelectodTodoNotValid(number)) return false;
    ...
    private static boolean isSelectodTodoNotValid(Integer number) {
        if (number <= 0) {
            return true;
        }
    ...
    public static boolean editTodoList(Integer number, String newTodo) {
        if (isSelectodTodoNotValid(number)) {
            return false;
        }
